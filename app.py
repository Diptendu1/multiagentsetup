...
recommendation_agent = create_recommendation_agent(llm_model)
recon_agent = create_recon_agent(llm_model)
...
supervisor_prompt = (
    ...
    "- a research agent. Assign tasks related to research. Research can be about a anything from a particular topic, company, region , people . "
    "- a reconciliation agent. Assign tasks related to reconciliation. Reconciliation can be performed on any documents which has original and final document. "
    "- a recommendation agent. Assign tasks related to recommendation. Recommendation can be about performing Gap analysis on the data and provide results as intervention cards .  "
...
supervisor = create_supervisor(
    model = llm_model,
    agents = [poem_agent, math_agent, weather_agent, launch_vehicle_agent, todoist_agent, research_agent, recon_agent, recommendation_agent],
